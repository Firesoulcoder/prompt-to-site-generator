    ...
    <div className="relative overflow-hidden bg-gradient-to-b from-background to-background/80">
      ...
      <div className="container py-24 lg:py-32 relative">
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
          <div className="rounded-full border px-4 py-1.5 text-sm font-medium mb-4 flex items-center gap-1.5 text-muted-foreground">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link to="/create">
              <Button className="bg-brand-indigo hover:bg-brand-indigo/90" size="lg">
                Create Website
      ...
      <div className="container pb-12 md:pb-24">
        <div className="rounded-xl overflow-hidden border shadow-lg bg-gradient-to-br from-gray-950 to-gray-900">
